...
Для использования сортировки в приложении Audiolist нужно создать отдельный файл с кодом, переместить его следующим под файл config.gs и обновить развертывание. В Audiolist применять как goofy функцию AulWave.
```javascript
